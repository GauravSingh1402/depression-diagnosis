...
function Home() {
  ...
  <path fill="#05386b" fill-opacity="1" d="M0,32L48,48C96,64,192,96,288,96C384,96,480,64,576,64C672,64,768,96,864,101.3C960,107,1056,85,1152,101.3C1248,117,1344,171,1392,197.3L1440,224L1440,0L1392,0C1344,0,1248,0,1152,0C1056,0,960,0,864,0C768,0,672,0,576,0C480,0,384,0,288,0C192,0,96,0,48,0L0,0Z"></path>
        ...
        <br/>
        <h4>Lorem, ipsum dolor sit amet consectetur adipisicing elit. Dolores ullam quo aperiam reprehenderit quae ipsa accusamus asperiores at placeat amet? Lorem ipsum dolor sit, amet consectetur adipisicing elit. Voluptates cupiditate et, sapiente atque dolore porro harum beatae dolor neque cum.</h4>
        <br/>
        <br/>
        <button onClick={surveypage}>Take Quick Survey</button>
        <footer className='footers'>
          <h3>Made By Advait,Gaurav and Hridayesh</h3>
        </footer>
    </div>
  )
}
