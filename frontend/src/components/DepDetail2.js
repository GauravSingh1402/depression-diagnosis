...
export class DepDetail2 extends Component {
  ...
  render() {
    ...
    <FormControl>
      <FormLabel align="left" id="demo-row-radio-buttons-group-label">Do you think that discussing a mental health issue with your employer would have negative consequences?</FormLabel>
      <RadioGroup
        row
        aria-labelledby="demo-row-radio-buttons-group-label"
        name="row-radio-buttons-group"
    ...
    <FormControl>
      <FormLabel align="left" id="demo-row-radio-buttons-group-label">Do you think that discussing a physical health issue with your employer would have negative consequences?</FormLabel>
    <RadioGroup
        row
        aria-labelledby="demo-row-radio-buttons-group-label"
        name="row-radio-buttons-group"
